...
/* 피드백 #2 — 헤더 우측 LinkedIn·언어 전환(지구본 드롭다운). 연결 주소는 답변 대기(Q1) */
export const HEADER_EXTRAS = {
  pendingTitle: "연결 주소 확정 대기 (고객 답변 Q1)",
  linkedin: { label: "in", aria: "LinkedIn", href: "#" }, // TODO: Q1 답변 후 실제 주소
  languageAria: "언어 선택",
  languages: [
    { label: "한국어", href: "#" }, // TODO: Q1 — 블로그 연결로 추정
    { label: "English", href: "#" }, // TODO: Q1 — 링크드인 연결로 추정
    { label: "中文", href: "#" }, // TODO: Q1 — 링크드인 연결로 추정
  ],
} as const;
