...
ANCHORS = {
    ...
    # 서비스 재편(피드백 #17) 이후의 섹션 id 기준
    "서비스-3": ("/services", "#registration", ""),
    "서비스-4": ("/services", "#overseas", ""),
    "서비스-5": ("/services", "#research", ""),
    "서비스-6": ("/services", "#strategy", ""),
    "서비스-7": ("/services", "#enforcement", ""),
    "서비스-8": ("/services", "#trade-secret", ""),
...
# 고객이 피드백 당시 보고 있던 사이트의 커밋 — 버전 칩 표시용 (v1 리뷰 라운드 재료)
